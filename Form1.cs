...
namespace CsharpApi
{
    public partial class Form1 : Form
    {
        ...
        {
            var userData = new { username = txtUsername.Text, pass = txtPassword.Text, email = txtEmail.Text, birthdate = txtbdate.Text, birthplace = txtbplace.Text, school = txtschool.Text };
